...
export SPARK_MASTER=yarn-client                         # Spark master url. eg. spark://master_addr:7077. Leave empty if you want to use local mode.
...
export ZEPPELIN_JAVA_OPTS="-Dhdp.version=2.3.1.0-2574"                     # Additional jvm options. for example, export ZEPPELIN_JAVA_OPTS="-Dspark.executor.memory=8g -Dspark.cores.max=16"
